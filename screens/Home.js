        ...
        return(
            <View style={{flexDirection: 'row', marginVertical: SIZES.padding * 2}}>
                <View style={{flex: 1}}>
                    ...
                    <Text style={{...FONTS.body2, color: COLORS.gray}}>Dang Tuan Nghia</Text>
                </View>
    ...
    function renderFeatures(){
        ...
        const renderItem = ({item}) => (
            ...
            >
                ...
                <Text style={{ textAlign: 'center', flexWrap: 'wrap', ...FONTS.body4, color: COLORS.black}}>{item.description}</Text>
            </TouchableOpacity>
        )
        return(
            <FlatList
